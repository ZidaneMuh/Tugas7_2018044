...
public class MainActivity extends AppCompatActivity {
    ...
    String s1[], s2[],s3[];
    int images[] = {R.drawable.gambarsamsung,R.drawable.gambarsamsungs,R.drawable.gambariiphone13};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s1 = getResources().getStringArray(R.array.phone);
        s2 = getResources().getStringArray(R.array.deskripsi);
        s3 = getResources().getStringArray(R.array.star);
        phoneAdavter appAdapter = new phoneAdavter(this, s1, s2, s3, images);
